const verifyEmail = function (otp: string) {
                      ...
                      <tr>
                        <td class="sm-px-24"
                          ...
                          <p style="margin: 0 0 24px;">
                            A request to create your ERP account was received. Use this link to confirm your account and log in
                          </p>
    ...
    const text = `Verify Email, A request to create your ERP account was received. Use this OTP to confirm your account and log in`;
    return {
        html: html,
        text: text,
    };
